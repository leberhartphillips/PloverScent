...
knitr::include_graphics("plover-pics.png")
```
...
Since one MP (FH47040) was sampled twice during brooding, we average the to samples, thereby we avoid pseudo-replication. 
